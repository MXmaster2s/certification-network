...
function checkPrereqs() {
  ...
  chmod 777 /home/rohit/workspace/certification-network/network/bin/configtxlator
...
function networkUp() {
  ...
  chmod 777 /home/rohit/workspace/certification-network/network/scripts/bootstrap.sh
...
function installChaincode() {
  ...
  checkPrereqs
  chmod 777 /home/rohit/workspace/certification-network/network/scripts/installChaincode.sh
...
function generateCerts() {
  chmod 777 /home/rohit/workspace/certification-network/network/bin/cryptogen
  which cryptogen
  if [ "$?" -ne 0 ]; then
...
function generateChannelArtifacts() {
  chmod 777 /home/rohit/workspace/certification-network/network/bin/configtxgen
  which configtxgen
  if [ "$?" -ne 0 ]; then
