...
const yaml = require('js-yaml');					//js-yaml module
const { FileSystemWallet, Gateway } = require('fabric-network');
let gateway;										//initialising a global variable

async function main(studentId, name, email) {		//async functions return a promise
